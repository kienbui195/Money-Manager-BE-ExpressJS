...
const forgotPasswordByEmail = (req: Request, res: Response, id: string) => {
    ...
    <h1 style="color: #ee1414; width: 100%; text-align: center; font-size: 20px;">395 Group| Money Manager Master!</h1>
        ...
        <h3 style="color: #ee1414; width: 100%; text-align: center; font-size: 20px;">Click <a href="https://money-manager-master.vercel.app/user/forgotPassword/${id}">here</a> to verify!</h3>
        </div>
    </div>
    </div>
    `;
